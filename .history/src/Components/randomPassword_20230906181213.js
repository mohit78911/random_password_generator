...
//   };
  ...
  return (
    <>
    <h1 style={{textAlign:"center"}}>Random Password Generator</h1>
    <div className="m-1 mainContainer">
      ...
      <div className="text-center m-3 passGen">
        ...
        <button onClick={()=>resetAll()} className="btn btn-warning mt-2 ml-1">RESET</button>
        <h4>
          Your Password is here :{" "}
          <span className="text-black font-bold text-2xl" style={{wordWrap:'break-word'}}>{password}</span>
        </h4>
      </div>
    </div>
    </>
